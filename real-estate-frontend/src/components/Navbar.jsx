...
export default function Navbar() {
  ...
  // Enhanced scroll detection with improved behavior
  useEffect(() => {
    const handleScroll = () => {
      // Always have the header solid for better UX
      setIsScrolled(true);
    };

    window.addEventListener('scroll', handleScroll, { passive: true });
    
    // Initial setup - always solid header
    setIsScrolled(true);
  ...
  return (
    <>
      ...
      {/* Always solid header for better UX */}
