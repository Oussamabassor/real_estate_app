...
const MOCK_FEATURED_PROPERTIES = [
  {
    ...
    description:
      "Beautiful luxury apartment with amazing city views. This premium property features high ceilings, modern appliances, and 24/7 security. Perfect for professionals seeking a convenient urban lifestyle.",
    price: 500000,
    type: "apartment",
  ...
  },
  {
    ...
    description:
      "Spacious bungalow with private pool and garden. This single-story home offers open-concept living with plenty of natural light and a beautiful backyard perfect for entertaining.",
    price: 750000,
    type: "bungalow",
  ...
  },
  {
    ...
    description:
      "Perfect starter home in a great location. This well-designed studio makes efficient use of space with modern fixtures and plenty of storage solutions.",
    price: 200000,
    type: "apartment",
    property_type: "apartment",
    bedrooms: 1,
  ...
  },
  {
    ...
    description:
      "Stunning oceanfront villa with panoramic sea views. Enjoy luxury living with direct beach access, infinity pool, and high-end finishes throughout.",
    price: 2500000,
    type: "bungalow",
    property_type: "bungalow",
    bedrooms: 5,
  ...
  },
  {
    ...
    description:
      "Trendy loft in the heart of the arts district. Features exposed brick walls, high ceilings, and industrial touches with modern amenities.",
    price: 450000,
    type: "apartment",
    property_type: "apartment",
    bedrooms: 2,
  ...
  },
  {
    ...
    description:
      "Beautiful wooden chalet with breathtaking mountain views. Perfect for winter sports enthusiasts or summer hiking getaways.",
    price: 850000,
    type: "bungalow",
    property_type: "bungalow",
    bedrooms: 3,
...
MOCK_FEATURED_PROPERTIES.forEach((property) => {
  ...
  property.floor =
    property.type === "apartment" ? Math.floor(Math.random() * 10) + 1 : 1;
  property.totalFloors =
    property.type === "apartment" ? Math.floor(Math.random() * 20) + 10 : 1;
...
const useFeaturedPropertiesHook = () => {
  ...
  useEffect(() => {
    const fetchFeaturedProperties = async () => {
      try {
        ...
        console.log(
          "Mock data prepared:",
          mockFeaturedProperties.length,
          "properties"
        );

        // Simulate API delay with a shorter timeout to improve UX
        setTimeout(() => {
          console.log("Setting properties and finishing loading");
        ...
        //     setProperties(mockFeaturedProperties); // Fallback to mock data
        // } finally {
        //     setLoading(false);
        // }
      } catch (err) {
        console.error("Error in featured properties hook:", err);
