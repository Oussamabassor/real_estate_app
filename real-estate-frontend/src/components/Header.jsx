...
export default function Header({ isScrolled }) {
  ...
  const [forceVisible] = useState(true);
  
  // Debug information
  console.log('Header component rendered', { isAuthenticated, user });
  ...
  const headerClasses = `fixed top-0 w-full transition-all duration-300 z-50 ${
    isScrolled || !isHomePage
      ? 'bg-white shadow-md py-2'
      : 'bg-transparent py-4'
  }`;

  // Apply forcible visibility for debugging
  ...
  return (
    <header className={headerClasses} style={containerStyle}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <img src="/logo.png" alt="LuxeStay" className="h-10 w-auto" onError={(e) => e.target.src = 'https://via.placeholder.com/40x40'} />
